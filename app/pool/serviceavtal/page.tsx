          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-4xl sm:text-5xl font-black text-slate-900 leading-none mb-4">
                Serviceavtal<br />
                <span className="text-slate-300">för pool 2026</span>
              </h1>
            ...
            <div className="w-full lg:w-80 xl:w-96 shrink-0">
              <div className="relative aspect-[4/3] rounded-3xl overflow-hidden">
                <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 30% 35%, #bfdbfe 0%, #93c5fd 40%, #3b82f6 100%)" }} />
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <p className="text-sm font-black text-white">Pool serviceavtal 2026</p>
                </div>
              </div>
            </div>
